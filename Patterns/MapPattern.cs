...
namespace LeagueBot.Patterns
{
    public abstract class MapPattern : Pattern
    {
        ...
        {
           new WaitUntilProcessFocusAction(LeagueConstants.LOL_GAME_PROCESS,"[TFT] » Launching game focus function..."),
           new WaitUntilColorAction(PixelsConstants.LIFE_BAR_CHECKER_POINT,ColorConstants.LIFE_BAR_CHECKER_COLOR,"[TFT] » Waiting for a game to load..."),
           new ExecuteAIAction(AI,"[TFT] » Launching AI ("+AI.GetType().Name+")..."),
        };
